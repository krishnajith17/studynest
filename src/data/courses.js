...
export const CATEGORY_META = {
  SCI: { label: "Basic Sciences & Math", color: "cyan", border: "#0ea5e9", bg: "rgba(14, 165, 233, 0.12)" },
  ENGG: { label: "Core Engineering", color: "indigo", border: "#6366f1", bg: "rgba(99, 102, 241, 0.12)" },
  HUM: { label: "Humanities & Mind", color: "emerald", border: "#10b981", bg: "rgba(16, 185, 129, 0.12)" },
};
...
export const ACADEMIC_QUOTES = [
  ...
  "“Engineering is the art of directing the great sources of power in nature for the convenience of man.”",
  "“One focused hour of deep study is worth ten hours of passive revision.”",
